...
void counterspell(Spell *spell) {
    ...
    /* 1. Use dynamic_cast to identify known spells */
    ...
    /* 2. Handle generic spells using LCS (Longest Common Subsequence) */
    else {
        string s_name = spell->revealScrollName();
        ...
        // Output the result for the generic spell
        cout << dp[m][n] << endl;
    }
